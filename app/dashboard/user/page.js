                ...
                <div className="flex flex-col items-center justify-center">
                    {
                        ...
                        <div className="w-full flex justify-start mb-6">
                            <ButtonPrimary name="Tambah User" action={createNavigate}  />
                            <ButtonPrimary name="Role User" action={handleRoleUser}  />
                        </div>
                    }
                    <TableUser aksesDelete={aksesMenuData.act_delete} aksesEdit={aksesMenuData.act_update} /> 
                </div>
                :
